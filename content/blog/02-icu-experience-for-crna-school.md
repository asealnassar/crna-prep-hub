---
article: 2
primary_keyword: ICU experience for CRNA school
secondary_keywords:
  - what ICU experience counts for CRNA school
  - best ICU for CRNA school
  - how many years of ICU experience for CRNA school
  - does ER experience count for CRNA school
long_tail_keywords:
  - does PACU count as ICU experience for CRNA school
  - is MICU or SICU better for CRNA school
  - can I apply to CRNA school with one year of ICU
  - what ICU skills do CRNA programs look for
search_intent: Informational with a decision attached. Reader is choosing a unit, considering a transfer, or checking whether their current experience qualifies. High stakes — the answer changes their timeline.
slug: /blog/icu-experience-for-crna-school
seo_title: What ICU Experience Counts for CRNA School? A Unit-by-Unit Guide
meta_description: Which ICUs qualify for CRNA school, which usually don't, how much experience you need, and what committees look for beyond time served.
---
...
**Verify every one of these individually.** This table describes common patterns, not rules. Programs set their own definitions, and a unit accepted by one school may be rejected by another in the same state. The [CRNA School Directory](/schools) is a starting point for filtering, but the program's own admissions office is the authority.
...
1. Do you independently manage vasoactive drips and ventilators?
2. Do you see enough instability to have real stories?
3. Can you explain the physiology behind your decisions, not just the protocol?
...
**The wrong read:** "I have eighteen months of experience, so I'm close."
**The correct read:** "I have zero qualifying months and my timeline starts when I transfer."
...
1. What was happening physiologically
...
Once you have that material, practicing under pressure is the next step; the [AI Mock Interview](/interview) tool runs clinical, emotional-intelligence, and mixed formats with adaptive follow-up questions, which is closer to how panels actually probe than rehearsing alone.

## Frequently asked questions

**Can I apply with less than one year of ICU experience?**
Sometimes. Many programs allow application during your first year if you'll meet the minimum by matriculation. Whether that's competitive is a separate question from whether it's permitted.

**Does travel or contract ICU experience count?**
Generally yes if the unit qualifies, though some programs prefer to see stability at one institution. Frequent short assignments can also make it harder to secure a strong, specific reference.

**Do I need CRRT, ECMO, or balloon pump experience?**
No program requires it. It strengthens your file and gives you more to discuss, but its absence is not disqualifying.

**Should I take a lower-paying ICU job to qualify?**
If your current unit doesn't qualify and CRNA school is the goal, then yes — because without qualifying experience, the rest of your application can't be evaluated at all.

**Does part-time ICU experience count?**
Programs typically specify full-time or full-time equivalent. Part-time may count pro-rata or may not count at all. Verify directly.

---

**Next step:** Confirm your unit qualifies at the programs you're targeting before you build a timeline around it. You can filter programs in the [CRNA School Directory](/schools), then verify the specifics with each admissions office — because a unit accepted by one program is sometimes rejected by another.
...
| CRNA School Directory (closing CTA) | /schools |

## Other Blog Posts in This Cluster to Link To

- **"CRNA school requirements"** (pillar) — from the opening
- **"CRNA school application timeline"** — from the transfer-decision scenario
- **"Is CCRN required for CRNA school"** — from the transfer sequence
- **"CRNA school interview questions"** — from the interview-material section

## Suggested CTA

Sitting on ICU experience you can't yet turn into interview answers? Practice explaining your own cases under adaptive follow-up questioning.
