---
article: 9
primary_keyword: CRNA school resume
secondary_keywords:
  - CRNA resume examples
  - ICU nurse resume for CRNA school
  - CRNA CV format
  - what to include on a CRNA application resume
long_tail_keywords:
  - how long should a CRNA school resume be
  - how to describe ICU experience on a resume
  - should I include a resume objective for CRNA school
  - CRNA resume vs CV difference
search_intent: Procedural. Reader is assembling application materials and wants format standards plus concrete before/after examples.
slug: /blog/crna-school-resume
seo_title: CRNA School Resume: What to Include and How to Format It
meta_description: How to structure a CRNA application resume, how to describe ICU experience so it demonstrates acuity, and before-and-after examples of bullets that work.
---
...
1. **Contact information** — name with credentials (RN, BSN, CCRN), phone, professional email, city/state, LinkedIn if maintained
2. **Licenses and certifications** — RN license with state, CCRN, ACLS, PALS, BLS, subspecialty certifications, with expiration dates
3. **Clinical experience** — reverse chronological, with unit type and acuity made explicit
4. **Education** — degree, institution, graduation date, GPA if strong
5. **Leadership and professional activity** — precepting, charge, committees, unit council
6. **Professional development** — relevant continuing education, conferences, additional coursework
7. **Volunteer or community work** — brief, if genuinely relevant
...
> CCRN (Adult), American Association of Critical-Care Nurses, exp. 03/2028
> ACLS, American Heart Association, exp. 09/2027
...
- **Filename:** `LastName_FirstName_Resume.pdf`, not `resume_final_v3.pdf`
- **Consistency:** Date formats, bullet punctuation, and tense should match throughout
...
If formatting is where you get stuck, the [Resume Builder](/resume-builder) follows these conventions by default, which frees you to focus on the content — which is the part that actually differentiates you.
...
> **Staff Registered Nurse — Surgical/Trauma ICU**, Memorial Hospital, June 2021–Present
> 20-bed Level I trauma SICU; 2:1 and 1:1 assignments
...
**How long should a CRNA school resume be?**
One to two pages for most applicants. Longer only if you have genuine research, publications, or extensive leadership.

**Should I include my GPA?**
If it's strong, yes. If it's a weakness, omit it from the resume — it appears on your transcript regardless, and the personal statement is a better place to provide context.

**Should I include non-nursing work history?**
Generally only if relevant or if it fills a gap. Older unrelated jobs can be omitted or compressed to a single line.

**Do I need a cover letter?**
Only if requested. Most CRNA applications use a personal statement instead.

**Should I list every continuing education course?**
No — only what's relevant and substantive. A long list of routine annual modules dilutes the page.

**Can I use a resume template?**
Yes, if it's clean and ATS-safe. Avoid designs with columns, graphics, or embedded tables that may not parse correctly.

---

**Next step:** Rewrite your clinical bullets to name specific drips, devices, and ratios before you worry about formatting — that's what makes acuity legible. The [Resume Builder](/resume-builder) handles the structure and conventions so your effort goes into the content committees actually read.
...
| Resume Builder (closing CTA) | /resume-builder |
| Personal Statement Analyzer | /personal-statement |

## Other Blog Posts in This Cluster to Link To

- **"ICU experience for CRNA school"** — from the making-acuity-visible section
- **"CRNA personal statement"** — from the GPA question in the FAQ
- **"How to prepare for a CRNA school interview"** — from the "consistency with the rest of your file" point
- **"CRNA school application timeline"** — from the opening

## Suggested CTA

Your resume has about thirty seconds to make your acuity legible. Make sure it names what you actually manage.
