    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              ...
              <Link href="/interview" className="text-gray-700 hover:text-blue-600">Mock Interview</Link>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">One-time payment. Lifetime access. No subscriptions.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border-2 border-gray-200">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> View all 129 CRNA schools</li>
              ...
              <li className="flex items-center text-gray-400"><span className="mr-2">✗</span> Mock interviews</li>
            </ul>
            
            <button className="w-full py-3 rounded-lg border-2 border-gray-300 text-gray-600 font-semibold">
              Current Plan
            </button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border-2 border-purple-500">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Unlimited mock interviews</li>
              ...
              <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Voice input support</li>
            </ul>
