          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
              ...
              {user && userTier === 'free' ? (
                ...
                <button disabled className="w-full py-3 rounded-xl border-2 border-gray-300 text-gray-400 font-semibold opacity-50 cursor-not-allowed">
                  —
                </button>
              )}
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-blue-500 relative">
              ...
              {user && userTier === 'premium' ? (
                <button className="w-full py-3 rounded-xl bg-blue-600 text-white font-semibold cursor-default">
                  Current Plan
                </button>
              ) : (
                <button onClick={() => handleCheckout('premium')} disabled={loading === 'premium'} className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold hover:opacity-90 transition disabled:opacity-50">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-purple-500 relative">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-purple-600 to-pink-500 text-white px-4 py-1 rounded-full text-sm font-semibold">
                BEST VALUE
              </div>
              ...
              <p className="text-gray-600 mb-6">Everything you need to succeed</p>
              ...
              {user && userTier === 'ultimate' ? (
                <button className="w-full py-3 rounded-xl bg-purple-600 text-white font-semibold cursor-default">
                  ⭐ Current Plan
                </button>
              ) : (
                <button onClick={() => handleCheckout('ultimate')} disabled={loading === 'ultimate'} className="w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 text-white font-semibold hover:opacity-90 transition disabled:opacity-50">
